 ...
 * 
 */
@WebServiceClient(name = "TestServiceImplService", targetNamespace = "http://service.test.linglong.plm.dxc.com/", wsdlLocation = "http://127.0.0.1:7001/test/TestService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICEIMPLSERVICE_QNAME = new QName("http://service.test.linglong.plm.dxc.com/", "TestServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:7001/test/TestService?wsdl");
    ...
    public TestService getTestServicePort() {
        return super.getPort(new QName("http://service.test.linglong.plm.dxc.com/", "TestServicePort"), TestService.class);
    }
    ...
    public TestService getTestServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.test.linglong.plm.dxc.com/", "TestServicePort"), TestService.class, features);
    }
